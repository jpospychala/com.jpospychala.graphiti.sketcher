/**
 */
package com.jpospychala.graphiti.sketcher.model.sketcher.util;
 ...
 * @generated
 */
public class SketcherSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SketcherPackage modelPackage;
	 ...
	 * @generated
	 */
	public SketcherSwitch() {
		if (modelPackage == null) {
			modelPackage = SketcherPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SketcherPackage.MODEL_OBJECT: {
