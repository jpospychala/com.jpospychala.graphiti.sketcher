...
public class CreatePolylineFeature extends AbstractCreateFeature {

	public CreatePolylineFeature(IFeatureProvider fp) {
		super(fp, "Polyline", "Create Polyline");
	}
	...
	public Object[] create(ICreateContext context) {
		Polyline ga = (Polyline) AlgorithmsFactory.eINSTANCE.createPolyline();
